"""
Tests for expanded IPCameraService with IP camera CRUD operations
"""
import pytest
import uuid
...
class TestIPCameraServiceExpanded:
    """Test cases for IPCameraService IP camera CRUD operations"""
    ...
    def test_create_ip_camera(self):
        ...
        # Execute
        camera = IPCameraService.create_camera(db, **camera_data)
    ...
    def test_list_user_cameras(self):
        ...
        # Execute
        cameras = IPCameraService.list_cameras_by_user(db, user_id)
    ...
    def test_update_camera(self):
        ...
        camera = IPCameraService.update_camera(db, camera_id, **updates)
