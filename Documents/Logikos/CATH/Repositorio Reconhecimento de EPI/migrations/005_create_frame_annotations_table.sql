...
COMMENT ON COLUMN frame_annotations.frame_id IS 'Reference to the frame being annotated';
COMMENT ON COLUMN frame_annotations.class_id IS 'Reference to the YOLO class (from classes_yolo table)';
